...
uint16_t g_sm_conf_pbgatt_adv_intvl                    = (500);           // x1ms
...
uint16_t g_sm_conf_proxy_id_intvl                      = (100);          // x10ms
uint16_t g_sm_conf_proxy_id_win                        = (20);            // x10ms
uint16_t g_sm_conf_proxy_id_adv_intvl                  = (50);           // x1ms
uint16_t g_sm_conf_proxy_con_intvl_min                 = 20;//(200);          // x1.25ms
uint16_t g_sm_conf_proxy_con_intvl_max                 = 20;//(1000);         // x1.25ms
...
uint16_t g_sm_conf_nwk_tx_q_size                       = (32);
