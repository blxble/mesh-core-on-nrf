...
#define SMMOD_MSG_OPCODE_DEV_COMPOSITION_DATA_STATUS                            {0x00, 0x00, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_PUBLICATION_SET                           {0x01, 0x00, 0x00}
#define SMMOD_MSG_OPCODE_APPKEY_ADD                                             {0x02, 0x00, 0x00}
#define SMMOD_MSG_OPCODE_APPKEY_UPDATE                                          {0x03, 0x00, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_CURRENT_STATUS                                  {0x04, 0x00, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_FAULT_STATUS                                    {0x05, 0x00, 0x00}
#define SMMOD_MSG_OPCODE_DEV_COMPOSITION_DATA_GET                               {0x90, 0x00, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_BEACON_GET                                      {0x90, 0x08, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_BEACON_SET                                      {0x90, 0x09, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_BEACON_STATUS                                   {0x90, 0x0A, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_ATTENTION_GET                                   {0x90, 0x10, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_ATTENTION_SET                                   {0x90, 0x11, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_ATTENTION_STATUS                                {0x90, 0x12, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_DEFAULT_TTL_GET                                 {0x90, 0x18, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_DEFAULT_TTL_SET                                 {0x90, 0x19, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_DEFAULT_TTL_STATUS                              {0x90, 0x1A, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_PROXY_GET                                       {0x90, 0x20, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_PROXY_SET                                       {0x90, 0x21, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_PROXY_STATUS                                    {0x90, 0x22, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_RELAY_GET                                       {0x90, 0x28, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_RELAY_SET                                       {0x90, 0x29, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_RELAY_STATUS                                    {0x90, 0x2A, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_PUBLICATION_GET                           {0x90, 0x30, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_PUBLICATION_VIRTUAL_ADDR_SET              {0x90, 0x31, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_PUBLICATION_STATUS                        {0x90, 0x32, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_ADD                          {0x90, 0x38, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_VIRTUAL_ADDR_ADD             {0x90, 0x39, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_DELETE                       {0x90, 0x3A, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_VIRTUAL_ADDR_DELETE          {0x90, 0x3B, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_OVERWRITE                    {0x90, 0x3C, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_VIRTUAL_ADDR_OVERWRITE       {0x90, 0x3D, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_DELETE_ALL                   {0x90, 0x3E, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_STATUS                       {0x90, 0x3F, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_GET                          {0x90, 0x40, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_MODEL_SUBSCRIPTION_LIST                         {0x90, 0x41, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_VENDOR_MODEL_SUBSCRIPTION_GET                   {0x90, 0x42, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_VENDOR_MODEL_SUBSCRIPTION_LIST                  {0x90, 0x43, 0x00}
#define SMMOD_MSG_OPCODE_NETKEY_ADD                                             {0x90, 0x48, 0x00}
#define SMMOD_MSG_OPCODE_NETKEY_UPDATE                                          {0x90, 0x49, 0x00}
#define SMMOD_MSG_OPCODE_NETKEY_DELETE                                          {0x90, 0x4A, 0x00}
#define SMMOD_MSG_OPCODE_NETKEY_STATUS                                          {0x90, 0x4B, 0x00}
#define SMMOD_MSG_OPCODE_NETKEY_GET                                             {0x90, 0x4C, 0x00}
#define SMMOD_MSG_OPCODE_NETKEY_LIST                                            {0x90, 0x4D, 0x00}
#define SMMOD_MSG_OPCODE_APPKEY_DELETE                                          {0x90, 0x52, 0x00}
#define SMMOD_MSG_OPCODE_APPKEY_STATUS                                          {0x90, 0x53, 0x00}
#define SMMOD_MSG_OPCODE_APPKEY_GET                                             {0x90, 0x54, 0x00}
#define SMMOD_MSG_OPCODE_APPKEY_LIST                                            {0x90, 0x55, 0x00}
#define SMMOD_MSG_OPCODE_NODE_IDENTITY_GET                                      {0x90, 0x58, 0x00}
#define SMMOD_MSG_OPCODE_NODE_IDENTITY_SET                                      {0x90, 0x59, 0x00}
#define SMMOD_MSG_OPCODE_NODE_IDENTITY_STATUS                                   {0x90, 0x5A, 0x00}
#define SMMOD_MSG_OPCODE_MODEL_APP_BIND                                         {0x90, 0x60, 0x00}
#define SMMOD_MSG_OPCODE_MODEL_APP_UNBIND                                       {0x90, 0x61, 0x00}
#define SMMOD_MSG_OPCODE_MODEL_APP_STATUS                                       {0x90, 0x62, 0x00}
#define SMMOD_MSG_OPCODE_SIG_MODEL_APP_GET                                      {0x90, 0x63, 0x00}
#define SMMOD_MSG_OPCODE_SIG_MODEL_APP_LIST                                     {0x90, 0x64, 0x00}
#define SMMOD_MSG_OPCODE_VENDOR_MODEL_APP_GET                                   {0x90, 0x65, 0x00}
#define SMMOD_MSG_OPCODE_VENDOR_MODEL_APP_LIST                                  {0x90, 0x66, 0x00}
#define SMMOD_MSG_OPCODE_NODE_RESET                                             {0x90, 0x68, 0x00}
#define SMMOD_MSG_OPCODE_NODE_RESET_STATUS                                      {0x90, 0x69, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_FRIEND_GET                                      {0x90, 0x70, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_FRIEND_SET                                      {0x90, 0x71, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_FRIEND_STATUS                                   {0x90, 0x72, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_KEY_REFRESH_PHASE_GET                           {0x90, 0x78, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_KEY_REFRESH_PHASE_SET                           {0x90, 0x79, 0x00}
#define SMMOD_MSG_OPCODE_CONFIG_KEY_REFRESH_PHASE_STATUS                        {0x90, 0x7A, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_FAULT_GET                                       {0x90, 0x7B, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_FAULT_CLEAR                                     {0x90, 0x7C, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_FAULT_CLEAR_UNRELIABLE                          {0x90, 0x7D, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_PERIOD_GET                                      {0x90, 0x7E, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_PERIOD_SET                                      {0x90, 0x7F, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_PERIOD_SET_UNRELIABLE                           {0x90, 0x80, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_PERIOD_STATUS                                   {0x90, 0x81, 0x00}
#define SMMOD_MSG_OPCODE_HEARTBEAT_PUBLICATION_GET                              {0x90, 0x82, 0x00}
#define SMMOD_MSG_OPCODE_HEARTBEAT_PUBLICATION_SET                              {0x90, 0x83, 0x00}
#define SMMOD_MSG_OPCODE_HEARTBEAT_PUBLICATION_STATUS                           {0x90, 0x84, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_FAULT_TEST                                      {0x90, 0x85, 0x00}
#define SMMOD_MSG_OPCODE_HEALTH_FAULT_TEST_UNRELIABLE                           {0x90, 0x86, 0x00}
#define SMMOD_MSG_OPCODE_HEARTBEAT_SUBSCRIPTION_GET                             {0x90, 0x87, 0x00}
#define SMMOD_MSG_OPCODE_HEARTBEAT_SUBSCRIPTION_SET                             {0x90, 0x88, 0x00}
#define SMMOD_MSG_OPCODE_HEARTBEAT_SUBSCRIPTION_STATUS                          {0x90, 0x89, 0x00}
#define SMMOD_MSG_OPCODE_ATTENTION_SET_UNRELIABLE                               {0x90, 0x8A, 0x00}
